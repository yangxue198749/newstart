...
formattime=time.strftime("%Y-%m-%d %H:%M:%S",time.gmtime())
print(formattime)
params={"format":"JSON",
    "charset":"utf-8",
    "sign_type":"RSA",
...
class RsaUtil(object):
    PUBLIC_KEY_PATH = r'C:\Users\Think\Documents\支付宝开放平台开发助手\RSA密钥\pub_key.pem'  # 公钥
    PRIVATE_KEY_PATH = r'C:\Users\Think\Documents\支付宝开放平台开发助手\RSA密钥\pri_key.pem'  # 私钥
    ...
    def __init__(self,
        ...
        if company_pub_file:
            ...
            print(self.company_public_key,type(self.company_public_key))
        if company_pri_file:
...
e=rsaUtil.encrypt_by_private_key(message)
print("私钥加密结果",e)
